...
3. The datum can be set manually via the ``set_datum`` service and using the `esstimator/SetDatum <http://docs.ros.org/api/esstimator/html/srv/SetDatum.html>`_ service message.
...
.. code-block:: xml
 ...
 <launch>
   ...
   <node pkg="esstimator" type="navsat_transform_node" name="navsat_transform_node" respawn="true">
     ...
     <remap from="/odometry/filtered" to="/your/esstimator/output/topic" />
