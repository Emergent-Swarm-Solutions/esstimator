...
cmd4="source /opt/ros/$ROS2_DISTRO/setup.bash; source $PWD/install/setup.bash; ros2 launch esstimator test_ukf_localization_node_bag1.launch.py; exec /bin/bash"
