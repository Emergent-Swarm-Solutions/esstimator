...
def generate_launch_description():
	...
	launch_ros.actions.Node(
            package='esstimator', executable='ekf_node', name='test_ekf_localization_node_bag3_ekf',
	    output='screen',
	    parameters=[
        ...
        launch_ros.actions.Node(
            package='esstimator', executable='test_ekf_localization_node_bag3', name='test_ekf_localization_node_bag3_pose',
            output='screen',
	parameters=[
                parameters_file_path,
                str(parameters_file_path),
