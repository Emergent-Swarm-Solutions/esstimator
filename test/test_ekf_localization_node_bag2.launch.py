...
def generate_launch_description():
    ...
    ekf_node = launch_ros.actions.Node(
        package='esstimator', executable='ekf_node', name='test_ekf_localization_node_bag2_ekf',
	    output='screen',
	    parameters=[
    ...
    test_ekf_localization_node_bag2 =  launch_ros.actions.Node(
            package='esstimator', executable='test_ekf_localization_node_bag2', name='test_ekf_localization_node_bag2_pose',
            output='screen',
	parameters=[
                parameters_file_path,
                str(parameters_file_path),
